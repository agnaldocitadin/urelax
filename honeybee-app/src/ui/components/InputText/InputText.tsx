...
import { GestureResponderEvent, KeyboardTypeOptions, NativeSyntheticEvent, TextInputFocusEventData, ViewStyle } from 'react-native'
        ...
        <Shimmer autoRun visible={!loading} isInteraction={false} colorShimmer={SHIMMER_COLORS}>
            <View style={style}>
                <SInputItem bgColor={bgColor} color={_borderColor} onTouchStart={onTouchStart}>
                    ...
                    <SInputContent>
                        { leftIcon && <SIcon type={Theme.ICON_PACK} name={leftIcon} fontSize={leftIconSize} color={leftIconColor}/>}
                        { !options ? 
                            <SInputDefault
                                {...others}
                                value={value}
