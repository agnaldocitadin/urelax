...
// https://coolors.co/cfdbd5-e8eddf-f5cb5c-242423-333533 - other

export const LOGO = require("../assets/imgs/logo.png")
export const PROFILE = require("../assets/imgs/profile.jpg")
